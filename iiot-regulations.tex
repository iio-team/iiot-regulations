...
A team consists of students from the same educational institution. If and only if a national organization has in charge all the management (see the National Committees section), students must come from the same institution or region in the mandatory spirit of preserving the format of the teams that compete in the national context.

Every team is coordinated by one team leader teacher, who will also register the team in the competition.
